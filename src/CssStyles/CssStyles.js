...
const CssStyles = StyleSheet.create({
    ...
    arrowbuttonview: { marginTop: '5%', justifyContent: 'center', alignContent: 'center', alignItems: 'center', marginTop: '5%', },
    arrowtext: {
        textAlign: 'center',
        textDecorationStyle: 'solid',
        textShadowRadius: 20,
    ...
    buttonview: { marginTop: '5%', justifyContent: 'center', alignContent: 'center', alignItems: 'center', marginTop: '5%', padding: '3%' },
    buttontext: {
        textAlign: 'center',
    ...
    whitebuttonview: { marginTop: '5%', justifyContent: 'center', alignContent: 'center', alignItems: 'center', marginTop: '5%', padding: '3%' },
    whitebuttontext: {
        textAlign: 'center',
        fontSize: RFValue(18, 812),
        color: '#792BA9',
    ...
    darkpurplebutton: {
        borderRadius: hp('5%',812), backgroundColor: "#4E1373", height: hp('5%',812), width: wp('80%',812), justifyContent: 'center', alignContent: 'center', alignItems: 'center', padding: '3%',
    },
    darkpurplebuttonview: { marginTop: '5%', justifyContent: 'center', alignContent: 'center', alignItems: 'center', marginTop: '5%', padding: '3%' },
    ...
    loginlogostyle:{ resizeMode: 'contain',width: wp('25%',812),
    height: hp('15%',812),},
