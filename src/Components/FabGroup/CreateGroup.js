...
import { View, Text, ImageBackground, Image, StyleSheet, Dimensions, FlatList, Modal, Pressable } from 'react-native';
    ...
    renderselecteditem = data => {
        ...
        return (
            <View >
                {data.item.selectedClass ?
                    <TouchableOpacity
                        style={{ width: '100%', alignContent: 'center', justifyContent: 'center', alignItems: 'center', height: hp('10%'),paddingHorizontal: 8,
                    }}
                        onPress={() => {
        ...
        return (
            <View style={styles.maincontainer}>
                ...
                <View style={{
                    ...
                    <TouchableOpacity onPress={() => { this.props.navigation.navigate("CreateGroupScreen") }}>
                        <Image styles={{
                            resizeMode: 'contain', width: wp('1%', 812),
                            height: hp('1%', 812)
