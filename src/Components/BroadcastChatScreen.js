        ...
        return (
            <View style={styles.maincontainer}>
                ...
                <ScrollView style={{ flex: 1, }}>
                    ...
                    <View style={{ alignItems: 'flex-end', margin: '2%', flexDirection: 'row' }}>

                        <View style={styles.RighttalkBubble}>
                            <View style={styles.RighttalkBubbleSquare} >
                                <View style={{margin: '1%', padding:'1%'}}>
                                    <Text style={{ flex: 3, fontSize: RFValue(14, 812), fontFamily: 'silka-regular-webfont',  }}>
                                ...
                                <View style={{ flexDirection: 'row', margin: '1%' }}>
                                    ...
                                    <View style={{ flex: 1, alignItems: 'flex-end', alignContent: 'flex-end', justifyContent: 'flex-end', marginTop: '2%', marginRight: '2%' }}>
                                        <View style={{ flex: 1, flexDirection:'row' }} >
                                            <Image source={require('../Images/purplecheck.png')} />
                                            <Image style={{left:-10,top:2 }} source={require('../Images/purplecheck.png')} />
                                        </View>
                                    </View>
                                </View>
                            </View>
                    ...
                    <View style={{ backgroundColor: 'transparent',  flexDirection: 'row', position: 'absolute', bottom: 5,width:'100%' ,justifyContent:'center',alignContent:'center',alignItems:'center',width: wp('100%', 812), }}>
                        <View style={{ backgroundColor: '#FAF4FF', borderWidth: 0.2, borderRadius: 50, borderColor: "#8E8E93", flexDirection: 'row', marginLeft: '1%',width: wp('85%',812),height:hp('5%',812) }}>
                           <View style={{ flex: 6,width: wp('90%', 812),justifyContent: 'center', height:'100%'}}>
                            <TextInput
                                style={{ fontSize: RFValue(14, 812), fontFamily: 'silka-medium-webfont', color: '#808080',marginLeft:'2%',height:hp('100%',812)}}
...
const styles = StyleSheet.create({
    ...
    h7lightwhitetext: { fontSize: RFValue(14, 812), color: '#7E8793', fontFamily: 'silka-medium-webfont', },
    ...
    purplebuttonview: { padding: '3%', width: wp('30%', 812), },
    purplebuttontext: {
        textAlign: 'center',
    ...
    redbutton: {
        borderRadius: hp('5%', 812), backgroundColor: "#67A5CA", height: hp('5%', 812), width: 'auto', justifyContent: 'center', alignContent: 'center', alignItems: 'center', elevation: 10, padding: '3%',
    },
    redbuttonview: { padding: '3%', width: wp('30%', 812), },
    redbuttontext: {
        textAlign: 'center',
        fontSize: RFValue(16, 812),
        color: '#fff',
