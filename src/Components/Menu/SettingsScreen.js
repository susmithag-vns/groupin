              ...
              <View style={{ flexDirection: 'row', width: '95%', }}>
                ...
                <View style={{ flexDirection: 'column', padding: '3%', width: '100%',marginRight:'2%' ,  }}>
                  <View style={{  padding: '1%', flex: 1, }}>
                    <Text style={TextStyles.h5whitebold}>Lucky Reddy</Text>
                  </View>
                  <View style={{ padding: '1%', flex: 1,width:'90%',marginRight:'2%' ,}}>
                    <Text numberOfLines={2} style={TextStyles.h5white}>Lorem Ipsum is simply dummy text of the printing and type setting industry. </Text>
                  </View>
                  <View style={{ padding: '1%', flex: 1, }}>
