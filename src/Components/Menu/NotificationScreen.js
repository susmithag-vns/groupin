...
class NotificationScreen extends React.Component {
    ...
    render() {
        return (
            ...
            <View style={{ height: hp('10%', 812), backgroundColor: '#792BA9', }}>
            ...
            source={require('../Images/bg.png')}> */}
                <View style={styles.mainfirstview}>
                    ...
                    <View style={styles.groupinviewstyle}>
                        <View style={{ flex: 1, justifyContent: 'center', alignContent: 'center', alignItems: 'flex-start', margin: '2%', marginBottom: '2%' }}>
                            <Text style={{ color: 'white', fontSize: RFValue(20, 812), fontFamily: 'silka-medium-webfont',marginLeft:'5%' }}>Notifications</Text>
            ...
            <View style={styles.cardview}>
                    ...
                    {this.state.switchValue ?
                        ...
                        :
                        <Text style={styles.toggletext}>  Mute All Notifications</Text>
                    }
...
const styles = StyleSheet.create({
    ...
    mainfirstview: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', padding: '3%', width: '100%',marginTop:'5%' },
    groupinviewstyle: {
    ...
    cardview: { elevation: 10, height: 'auto', backgroundColor: '#fff', borderRadius: 10, marginLeft: '5%', padding: '4%', marginRight: '5%', marginTop: '4%', },
    toggleview: { marginLeft: 'auto',justifyContent: 'flex-start', alignContent: 'center', alignItems: 'center',},
    textcolor:{color:'#792BA9',fontFamily: 'silka-bold-webfont',fontSize: RFValue(16, 812)},
    toggletext:{ fontSize: RFValue(16, 812), fontFamily: 'silka-medium-webfont', color: '#000', textAlign: 'center', },
    toggletextcolor:{ fontSize: RFValue(16, 812), fontFamily: 'silka-medium-webfont', color: '#792BA9', textAlign: 'center', },
