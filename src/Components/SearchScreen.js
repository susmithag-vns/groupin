    ...
    render() {
        return (
            <View style={styles.maincontainer}>
                {/* <View > */}
                    <ImageBackground style={CssStyles.backgroundImage,{height:hp('10%',812)}}
                        resizeMode='cover'
                        ...
                        <View style={styles.mainfirstview}>
                                ...
                                <View style={{ backgroundColor: "#B388CD" ,flex:3, height: hp('5%',812),borderWidth:1,borderRadius:hp('9%',812),marginRight:'2%',borderColor:"#B388CD"}}>
                                    <TextInput
                                        style={{ height: hp('5%',812), fontSize:RFValue(16, 812) ,fontFamily:'silka-medium-webfont',color:'#fff',width:'100%',height:'100%',}}
                ...
                <View style={{ flex: 3, backgroundColor: '#F7FCFC' }}>
                    <FlatList
...
const styles = StyleSheet.create({
    ...
    roundrecimagestyles: {  resizeMode: 'contain', width: wp('3%',812),
    height: hp('3%',812),},
